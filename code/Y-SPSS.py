...
spss_pcwag.single_sample_pcwag('data/data_for_spss.dat', output = 'signature_results', sigbase = '../input/COSMIC_v3_SBS_GRCh38_for_spss-RELEVANT.txt', n_cpu = 1)  # n_cpu = 1 to allow running in parallel with other runs
