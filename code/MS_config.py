...
header_line = 'weights\tsamples\tmuts\tTAE\tTAE_TP\tn_eff\twT\twT_FP\tn_FP\twT_FN\tn_FN\tP\tR\tS\tF1\tMCC'              # header for the concise result tables (printed)
header_line_full = 'weights\tsamples\tmuts\tTAE\tTAE_std\tRMSE\twT\tn_eff\tTAE_TP\twT_FP\twT_FP_std\tn_FP\twT_FN\tn_FN\tP\tP_std\tR\tR_std\tS\tS_std\tF1\tF1_std\tMCC\tMCC_std'      # header for the full result tables (saved)
