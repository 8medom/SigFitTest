...
cosmic3 <- read.table("../input/COSMIC_v3_SBS_GRCh38_for_sigLASSO-RELEVANT.txt", row.names = 1, header = TRUE, check.names = FALSE, sep = ",")
spectrum <- data.matrix(read.table("data/data_for_sigLASSO.dat", row.names = 1, header = TRUE, check.names = FALSE))
